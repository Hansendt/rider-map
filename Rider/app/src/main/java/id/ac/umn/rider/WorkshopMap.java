...
import id.ac.umn.rider.databinding.ActivityWorkshopMapBinding;

public class WorkshopMap extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        workshop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                stringBuilder.append("&type=repair");
                stringBuilder.append("&keyword=bengkel");
