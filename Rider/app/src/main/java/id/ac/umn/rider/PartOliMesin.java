...
public class PartOliMesin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_part_olimesin);
        ...
        updateTanggal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(PartOliMesin.this, R.style.datePicker, (view1, year, month, dayOfMonth) -> {
